...
var map = {
	"./cancer/cancer.module": [
		"./src/app/cancer/cancer.module.ts",
		"cancer-cancer-module"
	],
	"./cancercauses/cancercauses.module": [
		"./src/app/cancercauses/cancercauses.module.ts",
		"cancercauses-cancercauses-module"
	],
	"./cancerconseils/cancerconseils.module": [
		"./src/app/cancerconseils/cancerconseils.module.ts",
		"cancerconseils-cancerconseils-module"
	],
	"./cancerconsequences/cancerconsequences.module": [
		"./src/app/cancerconsequences/cancerconsequences.module.ts",
		"cancerconsequences-cancerconsequences-module"
	],
	"./diabete/diabete.module": [
		"./src/app/diabete/diabete.module.ts",
		"diabete-diabete-module"
	],
	"./diabetecauses/diabetecauses.module": [
	...
	"./diabeteconsequences/diabeteconsequences.module": [
	...
	"./pression/pression.module": [
		"./src/app/pression/pression.module.ts",
		"pression-pression-module"
	],
	"./pressioncauses/pressioncauses.module": [
		"./src/app/pressioncauses/pressioncauses.module.ts",
		"pressioncauses-pressioncauses-module"
	],
	"./pressionconseils/pressionconseils.module": [
		"./src/app/pressionconseils/pressionconseils.module.ts",
		"pressionconseils-pressionconseils-module"
	],
	"./pressionconsequences/pressionconsequences.module": [
...
module.exports = __webpack_require__(/*! /var/www/html/Advices/src/main.ts */"./src/main.ts");
